  ...
  data() {
    return {
      ...
      info: {
        ...
        group: {
          5: {
            start: "12-ти Януари 2020",
            when: "Всяка неделя 9:00-11:00",
            description: "",
            price: "Цената на курса е 80лв на месец. Ако предплатите за целия първи срок (3 месеца наведнъж) получавате над 10% отстъпка и цената е 215лв."
          },
          6: {
            start: "12-ти Януари 2020",
            when: "Всяка неделя 13:45-15:45",
            description: "",
            price: "Цената на курса е 80лв на месец. Ако предплатите за целия първи срок (3 месеца наведнъж) получавате над 10% отстъпка и цената е 215лв."
          },
          7: {
            start: "11-ти Януари 2020",
            when: "Всяка събота 9:00-12:00 / Всяка неделя 16:00-19:00",
            description: "",
            price: "Цената на курса е 120лв на месец. Ако предплатите за целия първи срок (3 месеца наведнъж) получавате над 10% отстъпка и цената е 320лв."
          },
          9: {
            start: "11-ти Януари 2020",
