<template>
  <section id="courses">
    <h2 class="text-center">Курсове Математика 2019/2020</h2>
    <v-container>
      ...
      info: {
        ...
        group: {
          5: {
            ...
            when: "Всяка неделя 9:00-11:00 и 11:30-13:30",
            description: "ул. Кирил и Методий 27",
            price: "Еднократно посещение - 25лв. 4 посещения - 80лв. 12 посещения - 230лв"
          },
          6: {
            start: "12-ти Януари 2020",
            when: "Всяка събота 14:00-16:00",
          ...
          7: {
            ...
            description: "ул. Кирил и Методий 27",
            price: "Еднократно посещение - 35лв. 4 посещения - 120лв. 12 посещения - 350лв"
          },
          9: {
            start: "11-ти Януари 2020",
            when: "Всяка събота 10:00-13:00",
            description: "ул. Кирил и Методий 27",
            price: "Еднократно посещение - 35лв. 4 посещения - 120лв. 12 посещения - 350лв"
          },
          10: {
