    ...
    <v-layout row wrap>
      <v-flex xs12 md-6>
        ...
        <p>
          ...
          use of Moonhythe's Website, located at www."Bg Mentor".app.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use "Bg Mentor" if you do not agree to
        ...
        <p>
          We employ the use of cookies. By accessing "Bg Mentor", you agreed to
          use cookies in agreement with the Moonhythe's Privacy Policy.
        </p>
        ...
        <p>
          ...
          intellectual property rights for all material on "Bg Mentor". All
          intellectual property rights are reserved. You may access this from
          "Bg Mentor" for your own personal use subjected to restrictions set in
        ...
        <p>
          ...
          Moonhythe does not filter, edit, publish or review Comments prior to
          their presence on the website. Comments do not reflect the views and
          opinions of Moonhythe,its agents and/or affiliates. Comments reflect
          the views and opinions of the person who post their views and
          opinions. To the extent permitted by applicable laws, Moonhythe shall
        ...
        <p>
          Moonhythe reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Moonhythe a non-exclusive license to use, reproduce,
        ...
        <p>
          ...
          the hyperlink compensates the absence of Moonhythe; and (d) the link
        ...
        <p>
          ...
          sending an e-mail to Moonhythe. Please include your name, your
        ...
        <p>
          No use of Moonhythe's logo or other artwork will be allowed for
