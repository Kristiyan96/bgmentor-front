    ...
    <v-layout row wrap>
      <v-flex xs12 md-6>
        ...
        <p>
          ...
          opinions and information in certain areas of the website. Moonhythe does
          ...
          Moonhythe,its agents and/or affiliates. Comments reflect the views and
          opinions of the person who post their views and opinions. To the extent
          permitted by applicable laws, Moonhythe shall not be liable for the
        ...
        <p>
          You hereby grant Moonhythe a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          hyperlink compensates the absence of Moonhythe; and (d) the link is in the
        ...
        <p>
          ...
          e-mail to Moonhythe. Please include your name, your organization name,
        ...
        <p>
          No use of Moonhythe's logo or other artwork will be allowed for linking
